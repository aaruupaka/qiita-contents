...
- `Local セットアップ`ウィンドウが展開されるのを確認します。
    <br>![alt text](images/20260503-02-03.png)

- `インストールオプションの選択`画面で下記の内容を選択し`次へ(N)>`を押下する。
    <br>![alt text](images/20260503-02-01.png) 

- `インストール先を選んでください。`画面で任意のインストール先フォルダを指定し、`インストール`ボタンを押下します。
    <br>![alt text](images/20260503-02-02.png)

- `インストール`画面に遷移することを確認します。
    <br>![alt text](images/20260503-02-04.png)

- `Localセットアップ ウィザードは完了しました。`画面が出たら`完了(F)`ボタンを押下します。
    <br>![alt text](images/20260503-02-05.png)

- LocalWPが起動することを確認します。
    <br>![alt text](images/20260503-02-06.png)