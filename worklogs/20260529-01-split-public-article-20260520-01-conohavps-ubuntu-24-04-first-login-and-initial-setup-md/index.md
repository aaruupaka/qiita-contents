# 概要
public内に追加している
`20260520-01-conohavps-ubuntu-24-04-first-login-and-initial-setup.md`を下記の二つの記事に分割します。
...
- `20260520-01-conohavps-ubuntu-24-04-first-login-and-initial-setup.md`は`ignorePublish`が`true`の状態の記事です。
    - Qiita上には記事が存在しない状態です。
    - もし仮に、`ignorePublish`が`false`の記事の場合、Qiita上で削除を行わなければいけない可能性があります。