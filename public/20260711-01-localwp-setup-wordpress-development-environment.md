...
## 初回起動時
- LocalWPが起動します。
    <br>![alt text](images/20260503-03-01.png)

- `Terms of Service`の内容を確認し、チェックボックスを有効化、`I agree`ボタンを押下します。
    <br>![alt text](images/20260503-03-02.png)
