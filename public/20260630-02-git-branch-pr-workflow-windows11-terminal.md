---
title: Git(GitHub)のブランチの作成からPR(プルリクエスト)の作成、マージまでの手順【初学者向け】
tags:
  - Git
  - GitHub
  - 初心者向け
  ...
  - 初学者向け
private: false
updated_at: '2026-07-10T16:32:11+09:00'
...
- ローカルリポジトリのルートディレクトリに移動します。

- 現在のブランチがmainであることを確認します。
  - 実行コマンド
    ```bash
    git branch
    ```
...
# おわりに
今回は、Gitでブランチを作成してから、GitHubでPR(プルリクエスト)を作成・マージし、ローカルリポジトリを最新の状態へ更新するまでの一連の流れを紹介しました。

一連の流れを何度か繰り返すことで、Gitを利用した基本的な開発フローに慣れていきます。

この記事が、これからGitやGitHubを学ぶ方の参考になれば幸いです。
