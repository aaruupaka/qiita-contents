...
tags:
  ...
  - Ubuntu24.04
private: false
updated_at: '2026-07-04T17:17:47+09:00'
...
- PHPがApache経由で動作するかを確認する。
    - phpinfo確認用のファイルを作成する。
        ...
        - `Ctrl + O`入力後、`Enter`を押し、編集モードを終了します。
        - `Ctrl + X`を押し、エディタを閉じます。
        - 確認事項
            - info.phpが作成されていることを確認します。
                - 実行コマンド
                    ```bash
                    ls /var/www/html/
                    ```
                ...
                - 確認事項
                    - info.phpが出力されることを確認します。
            - info.phpのファイル内容が意図したものになっていることを確認します。
                - 実行コマンド
                    ```bash
                ...
                - 確認事項
                    - 下記の内容と出力内容が一致することを確認します。
                        ```php
                        <?php
                        phpinfo();
                        ?>
                        ```
                    - `q`を押し、lessコマンドを終了します。

    - ブラウザでinfo.phpにアクセスします。
        - URL
        ...
        - 確認事項
            - PHP Versionが`8.3.x`であることを確認します。
            - Server APIが`Apache 2.0 Handler`であることを確認します。
    ...
    - phpinfo確認用ファイルを削除
        ...
        - 対応事項
            - 削除対象が`/var/www/html/info.php`であることを確認し`y`入力し、`Enter`を押下します。
        - 確認事項
            - info.phpが削除されていることを確認します。
                - 実行コマンド
                    ```bash
                    ls /var/www/html/
                    ```
